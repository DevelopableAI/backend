...
class VersionControl:
    ...
    def _create_github_repo(self) -> tuple[str, str]:
        ...
        payload = {
            ...
            "description": self._build_repo_description(),
            "auto_init": False,
        }
    ...
    def _build_repo_description(self) -> str:
        slug = self.repo_name.replace("-", " ")
        return f"Generated by Developable — {slug} Express API service"
